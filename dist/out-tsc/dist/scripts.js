...
(function (factory) {
    ...
    $.extend(Notify.prototype, {
        ...
        close: function () {
            var self = this, $successors = null, posX = parseInt(this.$ele.css(this.settings.placement.from)), hasAnimation = false;
...
(function (root, factory) {
    ...
    (function (window, document, Chartist) {
        ...
        Chartist.optionsProvider = function (options, responsiveOptions, eventEmitter) {
            var baseOptions = Chartist.extend({}, options), currentOptions, mediaQueryListeners = [], i;
        ...
        Chartist.Interpolation.cardinal = function (options) {
            ...
            return function cardinal(pathCoordinates, valueData) {
                ...
                if (!segments.length) {
                    ...
                    var path = new Chartist.Svg.Path().move(pathCoordinates[0], pathCoordinates[1], false, valueData[0]), z;
    ...
    (function (window, document, Chartist) {
        ...
        function extend(properties, superProtoOverride) {
            ...
            var constr = function () {
                var fn = proto.constructor || function () { }, instance;
    ...
    (function (window, document, Chartist) {
        ...
        function addClass(names) {
            this._node.setAttribute('class', this.classes(this._node)
        ...
        function animate(animations, guided, eventEmitter) {
            ...
            Object.keys(animations).forEach(function createAnimateForAttributes(attribute) {
                function createAnimate(animationDefinition, guided) {
                    var attributeProperties = {}, animate, timeout, easing;
    ...
    (function (window, document, Chartist) {
        ...
        function createChart(options) {
            ...
            data.raw.series.forEach(function (series, index) {
                ...
                var start = Chartist.polarToCartesian(center.x, center.y, radius, overlappigStartAngle), end = Chartist.polarToCartesian(center.x, center.y, radius, endAngle);
...
//# sourceMappingURL=../../../SalaryCalculator.Web/dist/scripts.js.map